...
class ModeloActualizarequipo extends Model{
    public $nombre;
    public $division;
    public $categoria;
    public $id;
    ...
    public function rules()
    {
        return [
          ...
          ['division', 'match', 'pattern' => "/^.{3,50}$/", 'message' => 'Mínimo 3 y máximo 50 caracteres'],
          ['categoria', 'match', 'pattern' => "/^.{3,50}$/", 'message' => 'Mínimo 3 y máximo 50 caracteres'],
